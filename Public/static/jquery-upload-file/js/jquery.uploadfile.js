...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript("static/jquery-upload-file/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropContainerStyle:"text-align:center;padding:50px 0;border-width:1px ;",
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    var dragDrop = $('<div class="' + s.dragDropContainerClass + '" style="'+s.dragDropContainerStyle+'"></div>').width(s.dragdropWidth);
                    $(obj).append(dragDrop);
