...
class Yichat {
    ...
    const QRCODE_IMG_URL = 'https://api.yixin.im/cgi-bin/qrcode/showqrcode?ticket=';
    ...
    const OAUTH_PREFIX = 'http://open.plus.yixin.im/connect/oauth2';
    const OAUTH_AUTHORIZE_URL = '/authorize?';
    const OAUTH_TOKEN_PREFIX = 'https://api.yixin.im/sns/oauth2';
    const OAUTH_TOKEN_URL = '/access_token?';
    const OAUTH_REFRESH_URL = '/refresh_token?';
    const OAUTH_USERINFO_URL = 'https://api.yixin.im/sns/userinfo?';

    /*  微信公众平台可用，易信公众号未开放相关接口
      const PAY_DELIVERNOTIFY = 'https://api.weixin.qq.com/pay/delivernotify?'; //发货通知
      const PAY_ORDERQUERY = 'https://api.weixin.qq.com/pay/orderquery?'; //查询订单信息
      const CUSTOM_SERVICE_GET_RECORD = '/customservice/getrecord?'; //多客服会话记录
      const CUSTOM_SERVICE_GET_KFLIST = '/customservice/getkflist?'; //获取多客服客服基本信息
      const CUSTOM_SERVICE_GET_ONLINEKFLIST = '/customservice/getkflist?'; //获取多客服在线客服接待信息
     */
