...
class WxHongBaoHelper
{
    ...
    protected $_parinerkey;
    protected $apiclient_cert;
    protected $apiclient_key;
    protected $rootca;
	function __construct($parinerkey, $apiclient_cert='', $apiclient_key='', $rootca='') {
		$this->_parinerkey = $parinerkey;
	...
	protected function get_sign(){
		define('PARTNERKEY', $this->_parinerkey);
		try {
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT, C('WWW_ROOT_PATH').$this->apiclient_cert);
 		curl_setopt($ch,CURLOPT_SSLKEY, C('WWW_ROOT_PATH').$this->apiclient_key);
 		curl_setopt($ch,CURLOPT_CAINFO, C('WWW_ROOT_PATH').$this->rootca);
