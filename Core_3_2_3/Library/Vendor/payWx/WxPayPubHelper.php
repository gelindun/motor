...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	$this->parameters["appid"] = C('WXPAY_APPID');//公众账号ID
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	$this->returnParameters["appid"] = C('WXPAY_APPID');//公众账号ID
		   	$this->returnParameters["mch_id"] = C('WXPAY_MCHID');//商户号
...
class JsApi_pub extends Common_util_pub
{
	...
	{
		$urlObj["appid"] = C('WXPAY_APPID');
		$urlObj["secret"] = C('WXPAY_APPSECRET');
